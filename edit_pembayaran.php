...
<header>
    <nav>
        <a href="pembayaran.php" class="nav__link"><i class="ri-arrow-left-line"></i></a>
        <h2 class="nav__title">Edit Tabel Pembayaran</h2>
    </nav>
</header>
...
if (isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM Pembayaran WHERE id_Pembayaran='$id'");
...
<form method="post" action="pembayaran.php">
    ...
    <input type="number" name="id_Penjualan" value="<?php echo htmlspecialchars($row['id_Penjualan']); ?>" required>

    <label>Tanggal Pembayaran:</label>
    <input type="date" name="Tanggal_Pembayaran" value="<?php echo htmlspecialchars($row['Tanggal_Pembayaran']); ?>" required>

    <label>Jumlah Pembayaran:</label>
    <input type="number" step="0.01" name="Jumlah_Pembayaran" value="<?php echo htmlspecialchars($row['Jumlah_Pembayaran']); ?>" required>
