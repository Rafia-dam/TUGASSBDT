...
<header>
    <nav>
        <a href="mekanik.php" class="nav__link"><i class="ri-arrow-left-line"></i></a>
        <h2 class="nav__title">Edit Tabel Mekanik</h2>
    </nav>
</header>
...
if (isset($_GET['id'])) {
    ...
    $result = $conn->query("SELECT * FROM Mekanik WHERE id_Mekanik='$id'");
...
<form method="post" action="mekanik.php">
    <input type="hidden" name="id_Mekanik" value="<?php echo htmlspecialchars($row['id_Mekanik']); ?>">
    
    <label>Nama:</label>
    <input type="text" name="Nama" value="<?php echo htmlspecialchars($row['Nama']); ?>" required>

    <label>Keahlian:</label>
    <input type="text" name="Keahlian" value="<?php echo htmlspecialchars($row['Keahlian']); ?>" required>

    <label>No Telepon:</label>
    <input type="text" name="No_Telepon" value="<?php echo htmlspecialchars($row['No_Telepon']); ?>" required>
