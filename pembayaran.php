...
<nav>
    ...
    <h2 class="nav__title">Tabel Pembayaran</h2>
</nav>
</header>
...
if (isset($_POST['update'])) {
    ...
    $sql_update = "UPDATE Pembayaran SET 
        id_Penjualan='$id_penjualan', Tanggal_Pembayaran='$tanggal_pembayaran', 
        Jumlah_Pembayaran='$jumlah_pembayaran', Metode_Pembayaran='$metode_pembayaran'
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && !isset($_POST['update'])) {
    ...
    $sql_insert = "INSERT INTO Pembayaran (id_Pembayaran, id_Penjualan, Tanggal_Pembayaran, Jumlah_Pembayaran, Metode_Pembayaran) 
                   VALUES ('$id_pembayaran', '$id_penjualan', '$tanggal_pembayaran', '$jumlah_pembayaran', '$metode_pembayaran')";

    $conn->query($sql_insert);
}

// Fetch data from the 'Pembayaran' table
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td>
                    <a href='?delete_id={$row['id_Pembayaran']}'>Hapus</a> 
...
<form method="post" action="">
    <label>ID Pembayaran:</label><input type="number" name="id_Pembayaran" required><br><br>
    <label>ID Penjualan:</label><input type="number" name="id_Penjualan" required><br><br>
    <label>Tanggal Pembayaran:</label><input type="date" name="Tanggal_Pembayaran" required><br><br>
    <label>Jumlah Pembayaran:</label><input type="number" step="0.01" name="Jumlah_Pembayaran" required><br><br>
