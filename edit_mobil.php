...
<body>
    <header>
        <nav>
            <a href="mobil.php" class="nav__link"><i class="ri-arrow-left-line"></i></a>
            <h2 class="nav__title">Edit Tabel Mobil</h2>
        </nav>
    </header>
...
<form method="post" action="mobil.php">
    ...
    <label>Merek:</label><input type="text" name="Merek" value="<?php echo $row['Merek']; ?>" required><br><br>
    <label>Model:</label><input type="text" name="Model" value="<?php echo $row['Model']; ?>" required><br><br>
    <label>Tahun Pembuatan:</label><input type="number" name="Tahun_Pembuatan" value="<?php echo $row['Tahun_Pembuatan']; ?>" required><br><br>
    <label>Nomor Plat:</label><input type="text" name="Nomor_Plat" value="<?php echo $row['Nomor_Plat']; ?>" required><br><br>
    <label>Warna:</label><input type="text" name="Warna" value="<?php echo $row['Warna']; ?>" required><br><br>
    <label>Transmisi:</label>
    <select name="Transmisi" required>
        <option value="Manual" <?php echo ($row['Transmisi'] == 'Manual') ? 'selected' : ''; ?>>Manual</option>
        <option value="Automatic" <?php echo ($row['Transmisi'] == 'Automatic') ? 'selected' : ''; ?>>Automatic</option>
    </select><br><br>
    <label>Tipe Bahan Bakar:</label>
    <select name="Tipe_Bahan_Bakar" required>
        <option value="Bensin" <?php echo ($row['Tipe_Bahan_Bakar'] == 'Bensin') ? 'selected' : ''; ?>>Bensin</option>
        <option value="Diesel" <?php echo ($row['Tipe_Bahan_Bakar'] == 'Diesel') ? 'selected' : ''; ?>>Diesel</option>
        <option value="Listrik" <?php echo ($row['Tipe_Bahan_Bakar'] == 'Listrik') ? 'selected' : ''; ?>>Listrik</option>
    </select><br><br>
    <label>Harga:</label><input type="number" name="Harga" value="<?php echo $row['Harga']; ?>" required><br><br>
    <label>Stock:</label><input type="number" name="Stock" value="<?php echo $row['Stock']; ?>" required><br><br>
    <Button type="submit" name="update" value="Update Data">Update Data</button>
</form>
